...
export const ChatGPT = () => {
  return (
    <section className={'bg-dark py-[54px] md:bg-grid md:bg-gridSize md:bg-bottom md:py-[66px] xl:py-[119px]'}>
      <Wrapper className={'flex flex-col items-center justify-between gap-7 xl:flex-row'}>
        <div className={'flex flex-col items-center gap-y-10 xl:max-w-[509px] xl:items-start'}>
          <h1 className={'text-center text-[28px] md:text-[40px] xl:text-left xl:text-[46px]'}>
